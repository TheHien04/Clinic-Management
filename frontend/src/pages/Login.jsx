...
import { MOCK_USERS, MOCK_OTP, STORAGE_KEYS, ROUTES } from '../constants';
  ...
  const handleOtpSubmit = e => {
    ...
    setTimeout(() => {
      ...
      if (otp === MOCK_OTP) {
        ...
        // Mock token for future use
        localStorage.setItem(STORAGE_KEYS.TOKEN, 'mock_jwt_token_' + Date.now());
