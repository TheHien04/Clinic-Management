...
const DoctorPieCharts = ({ doctors }) => {
  ...
  const specialtyColors = ['var(--brand-500)','var(--success-fg)','var(--warning-fg)','var(--danger-fg)','#0288d1','#8e24aa','var(--warning-fg)'];
  ...
  const statusColors = ['var(--success-fg)','var(--warning-fg)','var(--danger-fg)'];

  return (
    <div style={{display:'flex',gap:32,justifyContent:'center',flexWrap:'wrap'}}>
      <div style={{background:'#fff',borderRadius:10,boxShadow:'0 2px 8px #e0e7ef',padding:18,minWidth:260}}>
        <div style={{fontWeight:600,marginBottom:10,color:'var(--brand-500)',fontSize:'1.08rem'}}>Specialty Ratio</div>
        <DonutChart
      ...
      <div style={{background:'#fff',borderRadius:10,boxShadow:'0 2px 8px #e0e7ef',padding:18,minWidth:260}}>
        <div style={{fontWeight:600,marginBottom:10,color:'var(--brand-500)',fontSize:'1.08rem'}}>Status Ratio</div>
        <DonutChart
